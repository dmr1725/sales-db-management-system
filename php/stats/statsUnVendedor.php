...
<head>
    ...
    <title>Stats de un vendedor</title>
</head>
<body>
    ...
    <table id = "table">
        ...
        // $query_name = "SELECT e.FirstName from vendedor e where e.vendedorID = '$vendedor_id' ";
